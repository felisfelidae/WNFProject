...
It was at this point I noticed a discrepancy in the behavior of the succession classes. Notice that when fire is removed, the Late2:Cls class reduces to nearly nothing, while the proportions of Late1:Cls rise to near-complete domination of the landscape. Now look back at the description according to the Allegheny-Cumberland BpS. By all accounts, it is the _mixed-maple_ stands which should dominate in the absence of fire and the oak-hickory forest which ought to become vanishingly small; this behavior would also be consistent with the original estimates of s-class coverage for the area, as mixed closed-canopy stands are predominant on the landscape
